         ...
         <div class="modal-dialog modal-dialog-centered" role="document">
           <div class="modal-content">
             ...
             <div class="modal-body py-4">
                 <input type="text" placeholder="Quality Assurance First Name" name="qa_fname" value="" id="" class="form-control">
                 <input type="text" placeholder="Quality Assurance Last Name" name="qa_lname" value="" id="" class="form-control">
                 <input type="text" placeholder="Quality Assurance Email Address" name="qa_email" value="" id="" class="form-control">
              </div>
         ...
         <div class="modal-dialog modal-dialog-centered" role="document">
           <div class="modal-content">
             ...
             <div class="modal-body py-4">
                 ...
                 <input type="text" placeholder="Quality Assurance First Name" name="qa_fname" value="{{ $item->qa_fname }}" id="" class="form-control">
                 <input type="text" placeholder="Quality Assurance Last Name" name="qa_lname" value="{{ $item->qa_lname }}" id="" class="form-control">
                 <input type="text" placeholder="Quality Assurance Email Address" name="qa_email" value="{{ $item->qa_email }}" id="" class="form-control">
              </div>
             <div class="modal-footer bg-secondary">
               <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
