                    ...
                    <div class="card-body">
                        ...
                        <div  class="form-group row" id="reason_container">
                            ...
                            <div id="reasonhold" class="col-md-6">
                                   ...
                                   <textarea style="resize:none;" name="reason_hold" value="" placeholder="Reason for Holding Customer"  id="" class="form-control" cols="10" rows="1">{{ $customers->reason_hold }}</textarea>
                            </div>
                        </div>
                        @endforeach
       ...
       <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content bg-dark">
           ...
           <div class="modal-body">
               ...
               <input type="text" name="customer_id" hidden value="{{$row->customer_id}}" id="">
