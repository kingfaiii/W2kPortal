            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body py-4">
                        <input type="text" placeholder="Customer First Name" name="customer_fname" value="" id=""
                            class="form-control">
                        <input type="text" placeholder="Customer Last Name" name="customer_lname" value="" id=""
                            class="form-control">
                        <input type="text" placeholder="Customer Email" name="customer_email" value="" id=""
                            class="form-control">
